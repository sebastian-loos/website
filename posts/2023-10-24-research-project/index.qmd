...
The focus lies on severe e-waste issues that ask for innovative, cost-effective, and sustainable training methods, given the environmental and health concerns associated with informal e-waste recycling practices [@forti2020global]. Analyses on the have underscored the effectiveness of XR technologies in training contexts, especially when traditional methods prove impractical due to
factors like danger and cost [@kaplan2021effects; @xie2021review].
